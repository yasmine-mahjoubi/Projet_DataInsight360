...
export class DashboardComponent implements OnInit {
  ...
  // Données statiques pour l'activité récente
  staticRecentActivity = [
    {
      id: 1,
      userName: 'Yassmine',
      action: 'a ajouté un nouveau dataset',
    ...
    },
    {
      id: 2,
      userName: 'Ranim',
      action: 'a ajouté deux nouveaux thèmes',
    ...
    },
    {
      id: 3,
      userName: 'Hana',
      action: 'a analysé deux datasets',
  ...
  getActivityIconColor(icon: string): string {
    switch(icon) {
      case 'file': return '#42a5f5';
      case 'folder': return '#ffa726';
      case 'chart': return '#66bb6a';
      case 'user': return '#ab47bc';
  ...
  // Méthodes pour l'area chart (utilisateurs)
